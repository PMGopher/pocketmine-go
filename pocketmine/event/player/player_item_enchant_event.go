...
// inventory/transaction.EnchantingTransaction and the option an enchantment.EnchantingOption.
...
func NewPlayerItemEnchantEvent(player Player, transaction, option any, inputItem, outputItem Item, cost int) *PlayerItemEnchantEvent {
...
func (e *PlayerItemEnchantEvent) GetOption() any { return e.option }
